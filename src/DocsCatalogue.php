...
final class DocsCatalogue
{
    ...
    public static function pages(): array
    {
        return [
            ...
            new DocsPage('orm', 'ORM', 'kinetis/orm: a data mapper over the query builder — typed repositories and entity queries with eagerly loaded belongs-to, has-one and has-many relationships, and a unit of work with change tracking and a transactional flush'),
