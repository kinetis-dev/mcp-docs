...
final class DocsCatalogue
{
    ...
    public static function pages(): array
    {
        return [
            ...
            new DocsPage('orm', 'ORM', 'kinetis/orm: a read-side data mapper over the query builder — typed repositories and entity queries, no writes, relationships, or change tracking'),
