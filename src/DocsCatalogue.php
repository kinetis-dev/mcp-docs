...
final class DocsCatalogue
{
    ...
    public static function pages(): array
    {
        return [
            ...
            new DocsPage('appendix-orbitron', 'Appendix: Orbitron', 'Command schemas and exit codes, installed-source tools, the full MCP catalogue, project wiring, diagnostics and the trust boundary'),
